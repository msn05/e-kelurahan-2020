  ...
  <div class="card">
   <div class="card-body">
    <div class="alert alert-info mb-0" role="alert">
     <h4 class="card-title">Halaman ini menampung data Staf yang dapat mengakses sistem E-kelurahan ini.</h4>
   </div>
 </div>
 <div class="card-body">
  <table id="datatable" class="tabelstaf table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  </table>
</div>
</div>
...
<script>
 $(document).ready( function () {
  ...
  $('.tabelstaf').DataTable({
   ...
   "scrollY":true,
   "ajax": {
    "url": "../../../api/data_users/administrator/request.php",
    "type": "POST"
  },
  "aoColumns" : [   
  ...
  { "data": "name_employee", "title": "Nama Staf", "name": "name_employee" },
  ...
  {"data":  "id_users", "title":"Aksi", "name":"id_users",
  "render": function(data,type,rows){
    if (Role == rows.id_users){
      return ``;
    }else{
     ...
     <span class=" mdi mdi-lock-question"></span>Aktifkan</a>`;
      ...
      return`
    <a href=?Halaman=staf&Aksi=form_update&if=DE&id=${rows.id_users}>
    <button type="button" class="btn btn-outline-warning btn-xs waves-effect waves-light" title="Ubah data"><span class="mdi mdi-account-edit-outline"></span>Ubah Data</button></a>   
    <a href="#" id="openModalLink" 
    data-id="${rows.id_users}"
    data-username = "${rows.username}"
    data-status = "${rows.Statusnya}"
